...
from models.PGD_yolo import Model
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    kpweights_HRNET = opt.kpweights_HRNET
    ...
    HRNET_pretrain = kpweights_HRNET
    if pretrained:
        with torch_distributed_zero_first(LOCAL_RANK):
    ...
    if HRNET_pretrain:
        weights_dict = torch.load(HRNET_pretrain, map_location='cpu')
        weights_dict = weights_dict if 'model' not in weights_dict else weights_dict['model']
        model.HRNETmodel.load_state_dict(weights_dict, strict=False)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--kpweights_HRNET', type=str, default='', help='initial keypoints weights path')
